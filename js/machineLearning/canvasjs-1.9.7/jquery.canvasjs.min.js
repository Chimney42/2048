...
a.creditText="CanvasJS.com"):(d=a.updateOption("creditText"),b=a.updateOption("creditHref"));if(a.creditHref&&a.creditText){a._creditLink||(a._creditLink=document.createElement("a"),a._creditLink.setAttribute("class","canvasjs-scoreChart-credit"),a._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(a.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),a._creditLink.setAttribute("tabIndex",
-1),a._creditLink.setAttribute("target","_blank"));if(0===a.renderCount||d||b)a._creditLink.setAttribute("href",a.creditHref),a._creditLink.innerHTML=a.creditText;a._creditLink&&a.creditHref&&a.creditText?(a._creditLink.parentElement||a._canvasJSContainer.appendChild(a._creditLink),a._creditLink.style.top=a.height-14+"px"):a._creditLink.parentElement&&a._canvasJSContainer.removeChild(a._creditLink)}}}function ga(a,d){var b=document.createElement("canvas");b.setAttribute("class","canvasjs-scoreChart-canvas");
...
0<this.container.clientHeight?this.container.clientHeight:this.height;this.width=c;this.height=f;this.x1=this.y1=0;this.x2=this.width;this.y2=this.height;this._selectedColorSet="undefined"!==typeof ha[this.colorSet]?ha[this.colorSet]:ha.colorSet1;this._canvasJSContainer=document.createElement("div");this._canvasJSContainer.setAttribute("class","canvasjs-scoreChart-container");this._canvasJSContainer.style.position="relative";this._canvasJSContainer.style.textAlign="left";this._canvasJSContainer.style.cursor=
...
return}b&&(scoreChart=this.scoreChart||this,chart.render())};M.prototype.addTo=function(a, d, b, c){c="undefined"===typeof c?!0:c;var f=ca[this._defaultsKey];f.hasOwnProperty(a)||f.publicProperties&&f.publicProperties.hasOwnProperty(a)&&"readWrite"===f.publicProperties[a]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[a]&&(this.options[a]=[]),a=this.options[a],b="undefined"===typeof b||null===b?a.length:b,a.splice(b,0,d),c&&(scoreChart=this.scoreChart||this,chart.render())):window.console&&
...
this.parent.options[this.optionsName];qa(d);var b=d.indexOf(this.options);0<=b&&d.splice(b,1)}else delete this.parent.options[this.optionsName];a&&(scoreChart=this.scoreChart||this,chart.render())};M.prototype.updateOption=function(a){var d=ca[this._defaultsKey],b=this.options.theme?this.options.theme:this.scoreChart&&this.scoreChart.options.theme?this.scoreChart.options.theme:"theme1",c={},f=this[a];b&&(ia[b]&&ia[b][this._defaultsKey])&&(c=ia[b][this._defaultsKey]);a in d&&(f=a in this.options?this.options[a]:c&&a in c?
...
f=0;f<c.length;f++)c[f].eventHandler.call(c[f].context,d)}"function"===typeof this[a]&&this[a].call(b||this.scoreChart,d)};U(A,M);A.prototype._updateOptions=function(){var a=this;this.updateOption("width");this.updateOption("height");this.updateOption("dataPointWidth");this.updateOption("dataPointMinWidth");this.updateOption("dataPointMaxWidth");this.updateOption("interactivityEnabled");this.updateOption("theme");this.updateOption("colorSet")&&(this._selectedColorSet="undefined"!==typeof ha[this.colorSet]?
...
b&&this.render()):A.base.set.call(this,a,d,b)};A.prototype.exportChart=function(a){a="undefined"===typeof a?{}:a;var d=a.format?a.format:"png",b=a.fileName?a.fileName:this.exportFileName;if(a.toDataURL)return this.canvas.toDataURL("image/"+d);Ba(this.canvas,d,b)};A.prototype.print=function(){var a=this.exportChart({toDataURL:!0}),d=document.createElement("iframe");d.setAttribute("class","canvasjs-scoreChart-print-frame");d.setAttribute("style","position:absolute; width:100%; border: 0px; margin: 0px 0px 0px 0px; padding 0px 0px 0px 0px;");
...
*/
(function(b,c,d,e){b.fn.CanvasJSChart=function(a){if(a){var b=this.first();a=new CanvasJS.Chart(this[0],a);b.children(".canvasjs-scoreChart-container").data("canvasjsChartRef",a);a.render();return this}return this.first().children(".canvasjs-scoreChart-container").data("canvasjsChartRef")}})(jQuery,window,document);
